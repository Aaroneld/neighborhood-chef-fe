          ...
          <Card className={`${cardClass.root} ${cardClass.landingPage}`}>
            <CardContent style={{ marginTop: '2%' }}>
              <Typography paragraph>
                ...
                friends, learn new recipes, and, most importantly, eat good food. Well, maybe not most
                important. We'll let you decide that. :)
              </Typography>
              <Typography paragraph>
                Built with love as a completely open source project. Learn more and how to contribute{' '}
                <a
                  style={{
                    color: 'gray',
                    textDecoration: 'underline',
                  }}
                  href={'https://github.com/Lambda-School-Labs/neighborhood-chef-fe'}
